...
if not LightUIDB.A_STATS == true then return end
...
local addonList = 50
local font = FONT
local fontSize = LightUIDB.STATS.SIZE
local fontFlag = "THINOUTLINE"
local textAlign = "CENTER"
local customColor = LightUIDB.STATS.COLOR
local useShadow = true
local showClock = LightUIDB.STATS.CLOCK
local use12 = false
