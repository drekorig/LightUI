...
LightUI:RegisterEvent("PLAYER_ENTERING_WORLD")
LightUI:SetScript("OnEvent", function(self, event)

if not LightUIDB.A_CHAT == true then return end
...
for i = 1, NUM_CHAT_WINDOWS do
	...
	local function CreateCopyButton(self)
		...
		self.Copy:SetNormalTexture("Interface\\AddOns\\LightUI\\inc\\media\\core\\copynormal")
		self.Copy:GetNormalTexture():SetSize(20, 20)

		self.Copy:SetHighlightTexture("Interface\\AddOns\\LightUI\\inc\\media\\core\\copyhighlight")
